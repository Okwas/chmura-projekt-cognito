...
import { socket, useAppStore } from './stores/app-store'
import { useEffect } from 'react'
import { GAME_FOUND, OPPONENT_LEFT, AFTER_MOVE, GAME_DRAW, GAME_WON, GAME_LOST } from '../../socket.messages'
...
function App() {
  ...
  switch (stage) {
    ...
    case 'draw':
      return (
        <EndGame text={DRAW_STRING} />
      )
    case 'won':
      return (
        <EndGame text={WON_STRING} />
      )
    case 'lost':
      return (
        <EndGame text={LOST_STRING} />
      )
    case "register":
      return (
        <Register />
